<%@page contentType="text/html; charset=UTF-8" isELIgnored="false"%>
        ...
        <c:forEach var="item" items="${menuBean.menus}">
                ...
                <div class="main-container">
                        ...
                        <div class="contents">
                                <h3 class="alert alert-success" style="width : 200px;">게시판 주인</h3>
                                <img src="static/${user.profileImageUrl}" style="border-radius : 30px;" class="profile-image" width="150px" height="200px">
                                <div class="profile-info"> <h4 class="alert alert-success ">이름 </h4>
                                <h4>${user.name}</h4>
        <h4 class="alert alert-success ">나이 </h4>
                        <h4>${user.age}</h4>
        </div>
        <div class="profile-history">
        <p><h4 class="alert alert-success ">연혁</h4></p>
                                <img width="650px" src="static/${user.imageUrl}">
                        </div>
        </div>
