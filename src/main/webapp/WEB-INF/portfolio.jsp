        <%@page contentType="text/html; charset=UTF-8" isELIgnored="false"%>
            ...
            <c:forEach var="item" items="${menuBean.menus}">
                ...
                <div class="contents">
                    <c:forEach var="thumbnail" items="${portfolioList.thumbnail}">
                        <button onclick="onclickThumbnail('${thumbnail.name}')">
                        <img width="200px" height="200px" class="img-thumbnail" src="${thumbnail.src}" alt="Card image cap">
                        </button>
                        <h5>${thumbnail.name}</h5>
                        <p>${thumbnail.introduce}</p>
                    </c:forEach>
                </div>
